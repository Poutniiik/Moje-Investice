...
def process_cli_command():
            ...
            if cmd == "/help":
                ...
                if 'ai_enabled' in st.session_state and not st.session_state.ai_enabled:
                    ...
                    if len(cmd_parts) > 1:
                        ...
                        if not fund:
                             # Zkusíme data stáhnout, pokud chybí
                             try:
    ...
    # ==========================================
    # 👇 AKTIVACE LÉTAJÍCÍHO AI CHATBOTKA 👇
    # ==========================================
    # Podmínka: AI musí být dostupná (API klíč) a povolená v nastavení
    if AI_AVAILABLE and st.session_state.get('ai_enabled', False):
