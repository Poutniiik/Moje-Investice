...
def ziskej_sektor(ticker):
    try: 
        ...
        s = t.info.get('sector', 'Ostatní')
        return s if s else 'Ostatní' # Pojistka proti None
    ...
    if page == "🏠 Přehled":
        ...
        if viz_data:
            ...
            with c1:
                ...
                # 🛡️ OPRAVA: Ošetření chybějících sektorů pro Treemapa
                vdf['Sektor'] = vdf['Sektor'].fillna("Ostatní") 
