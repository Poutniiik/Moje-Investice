...
from src.services.portfolio_service import proved_nakup, proved_prodej, proved_smenu, pohyb_penez, invalidate_data_core, get_zustatky
from src.data_manager import uloz_data_uzivatele, SOUBOR_CASH
import src.bank_engine as bank

def render_obchod_page(USER, df, LIVE_DATA, zustatky):
