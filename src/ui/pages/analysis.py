...
from src.ui.components.charts import make_plotly_cyberpunk, add_download_button
from src.services.market_data import ziskej_detail_akcie, ziskej_earnings_datum, ziskej_kurzy
...
def render_analysis_page(df, df_watch, vdf, model, AI_AVAILABLE, hist_vyvoje, kurzy, celk_hod_usd, celk_inv_usd, celk_hod_czk, viz_data_list, LIVE_DATA):
                ...
                if raw_data.empty:
                    ...
                    for t in tickers_to_compare[:4]:
                        ...
                        if i:
                            ...
                            dy = i.get('dividendYield', 0) # Fixed here, assume it is correctly returned
